...
const sample = [
        {category:'React js', quantity: (Math.random()*10).toFixed(0)},
        {category:'Next js', quantity: (Math.random()*10).toFixed(0)},
        {category:'Angular', quantity: (Math.random()*10).toFixed(0)},
        {category:'Vue js', quantity: (Math.random()*10).toFixed(0)}
]
